...
- If the workflow reuses an upstream entry context, do not restate that the downstream workflow establishes that upstream context; state that it starts from or reuses that established context instead
